# Based off Alex's original at https://github.com/alexschultz/deepracer-for-dummies/blob/master/docker/dockerfiles/rl_coach/Dockerfile
...
# Not adding coach here anymore. Must be mounted as a volume at runtime.
